...
Just navigate to the Hass.io panel in your Home Assistant frontend and add the OpenVPN Client add-on repository: https://github.com/emiliaguerzoni/homeassistant-openvpn-client-addon
